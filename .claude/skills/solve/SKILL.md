...
- **Pułap kosztowy: domyślnie `model="claude-haiku-4-5"` — najtańszy dostępny model.** Piotr świadomie ogranicza koszty na czas przechodzenia przez kurs — nie sięgaj po Claude Sonnet 5, Claude Opus 5 ani Claude Fable 5, chyba że wyraźnie o to poprosi albo zadanie ćwiczenia realnie wymaga zdolności poza warstwą Haiku (rzadkie na tym etapie kursu). Pełne uzasadnienie tej zasady: `.claude/skills/swap/SKILL.md`.
